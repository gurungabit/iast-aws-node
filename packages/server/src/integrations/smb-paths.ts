...
const OFFICE_PATHS: OfficePath[] = [
  {
    ...
    office: '00',
    zoneOcs: ['00'],
    path: '\\\\Opr.statefarm.org\\dfs\\corp\\00\\WORKGROUP\\iAST',
  },
  {
    zone: 'GREAT LAKES',
    office: '01',
    zoneOcs: ['01', '04', '18'],
    path: '\\\\Opr.statefarm.org\\dfs\\ZONE\\GREAT LAKES\\WORKGROUP\\iAST',
  },
  {
    zone: 'CALIFORNIA',
    office: '02',
    zoneOcs: ['02', '12', '23'],
    path: '\\\\Opr.statefarm.org\\dfs\\ZONE\\CALIFORNIA\\WORKGROUP\\iAST',
  },
  {
    zone: 'GREAT LAKES',
    office: '04',
  ...
  },
  {
    ...
    office: '05',
    zoneOcs: ['05', '06'],
    path: '\\\\Opr.statefarm.org\\dfs\\ZONE\\HEARTLAND\\WORKGROUP\\iAST',
  },
  {
    zone: 'HEARTLAND',
    office: '06',
  ...
  },
  {
    ...
    office: '07',
    zoneOcs: ['07', '21'],
    path: '\\\\Opr.statefarm.org\\dfs\\ZONE\\MID-ATLANTIC\\WORKGROUP\\iAST',
  },
  {
    zone: 'TEXAS',
    office: '08',
    zoneOcs: ['08', '25'],
    path: '\\\\Opr.statefarm.org\\dfs\\ZONE\\TEXAS\\WORKGROUP\\iAST',
  },
  {
    zone: 'SOUTHERN',
    office: '09',
    zoneOcs: ['09', '27'],
    path: '\\\\Opr.statefarm.org\\dfs\\ZONE\\SOUTHERN\\WORKGROUP\\iAST',
  },
  {
    zone: 'MID-AMERICA',
    office: '11',
    zoneOcs: ['11', '16'],
    path: '\\\\Opr.statefarm.org\\dfs\\ZONE\\MID-AMERICA\\WORKGROUP\\iAST',
  },
  {
    zone: 'CALIFORNIA',
    office: '12',
  ...
  },
  {
    ...
    office: '13',
    zoneOcs: ['13', '17', '28'],
    path: '\\\\Opr.statefarm.org\\dfs\\ZONE\\NORTHEAST\\WORKGROUP\\iAST',
  },
  {
    zone: 'CENTRAL',
    office: '14',
    zoneOcs: ['14', '22', '26'],
    path: '\\\\Opr.statefarm.org\\dfs\\ZONE\\CENTRAL\\WORKGROUP\\iAST',
  },
  {
    zone: 'PACIFIC NORTHWEST',
    office: '15',
    zoneOcs: ['15'],
    path: '\\\\Opr.statefarm.org\\dfs\\ZONE\\PACIFIC NORTHWEST\\WORKGROUP\\iAST',
  },
  {
    zone: 'MID-AMERICA',
    office: '16',
  ...
  },
  {
    ...
    office: '19',
    zoneOcs: ['19'],
    path: '\\\\Opr.statefarm.org\\dfs\\ZONE\\FLORIDA\\WORKGROUP\\iAST',
  },
  {
    zone: 'GREAT WESTERN',
    office: '20',
    zoneOcs: ['20', '24'],
    path: '\\\\Opr.statefarm.org\\dfs\\ZONE\\GREAT WESTERN\\WORKGROUP\\iAST',
  },
  {
    zone: 'MID-ATLANTIC',
    office: '21',
...
/** FTP 412 Canada path */
export const FTP_412_CANADA_PATH =
  '\\\\Opr.statefarm.org\\dfs\\ZONE\\CANADA\\WORKGROUP\\FTP\\FTP_412'
