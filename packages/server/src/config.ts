...
const envSchema = z.object({
  ...
  DB2_DATABASE: z.string().default(''),
  DB2_HOSTNAME: z.string().default(''),
  DB2_PORT: z.coerce.number().default(446),
  DB2_PROTOCOL: z.string().default('TCPIP'),
  DB2_UID: z.string().default(''),
  DB2_PWD: z.string().default(''),
  DB2_SCHEMA: z.string().default('RU99'),
...
export const config = {
  ...
  db2Database: parsed.DB2_DATABASE,
  db2Hostname: parsed.DB2_HOSTNAME,
  db2Port: parsed.DB2_PORT,
  db2Protocol: parsed.DB2_PROTOCOL,
  db2Uid: parsed.DB2_UID,
  db2Pwd: parsed.DB2_PWD,
  db2Schema: parsed.DB2_SCHEMA,
