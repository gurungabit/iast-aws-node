...
const FIELD_SPECS: Array<[string, number, number]> = [
  ['office_num', 1, 2], ['division', 3, 1], ['numeric_company_code', 4, 1],
  ['pui', 5, 2], ['alpha_company_code', 7, 1], ['high_order', 8, 2],
  ['term_digits', 10, 4], ['check_digit', 14, 1],
  ['agent', 22, 4], ['afo', 29, 4],
  ['pt_written_date', 34, 8], ['pt_written_time', 43, 6],
  ['pt_effective_date', 50, 8], ['received_date', 59, 8],
  ['queue_name', 68, 15], ['queue_detail', 84, 15],
  ['text_message1', 100, 50], ['text_message2', 151, 50],
  ['text_message3', 202, 50], ['text_message4', 253, 50],
  ['stream_id', 307, 1], ['images', 309, 1],
  ['last_working_user', 311, 6], ['status', 318, 1],
  ['serv_or_undr', 320, 1], ['policy_item', 322, 10],
  ['system_policy_type', 333, 2], ['system_form_line', 336, 2],
  ['car_code', 339, 2], ['flmp_code', 342, 5],
  // Rout action sets 1-5
  ['rout_from_user1', 348, 6], ['rout_to_user1', 355, 6],
  ['rout_action1', 362, 6], ['rout_action_date1', 369, 8],
  ['und_serv1', 378, 1], ['pend_action1', 380, 6],
  ['pend_user1', 387, 6], ['pend_till1', 394, 8], ['pend_date1', 403, 8],
  ['rout_from_user2', 412, 6], ['rout_to_user2', 419, 6],
  ['rout_action2', 426, 6], ['rout_action_date2', 433, 8],
  ['und_serv2', 442, 1], ['pend_action2', 444, 6],
  ['pend_user2', 451, 6], ['pend_till2', 458, 8], ['pend_date2', 467, 8],
  ['rout_from_user3', 476, 6], ['rout_to_user3', 483, 6],
  ['rout_action3', 490, 6], ['rout_action_date3', 497, 8],
  ['und_serv3', 506, 1], ['pend_action3', 508, 6],
  ['pend_user3', 515, 6], ['pend_till3', 522, 8], ['pend_date3', 531, 8],
  ['rout_from_user4', 540, 6], ['rout_to_user4', 547, 6],
  ['rout_action4', 554, 6], ['rout_action_date4', 561, 8],
  ['und_serv4', 570, 1], ['pend_action4', 572, 6],
  ['pend_user4', 579, 6], ['pend_till4', 586, 8], ['pend_date4', 595, 8],
  ['rout_from_user5', 604, 6], ['rout_to_user5', 611, 6],
  ['rout_action5', 618, 6], ['rout_action_date5', 625, 8],
  ['und_serv5', 634, 1], ['pend_action5', 636, 6],
  ['pend_user5', 643, 6], ['pend_till5', 650, 8], ['pend_date5', 659, 8],
  // Post-rout fields
  ['sort_area', 668, 1], ['audit', 670, 1], ['county', 672, 3],
  ['zone', 676, 2], ['clnt_id', 679, 11], ['description', 691, 30],
  ['gfu_code', 722, 4], ['gfu_error_text', 727, 231],
  // Error codes 1-8
  ['error_code1', 959, 11], ['error_code2', 971, 11],
  ['error_code3', 983, 11], ['error_code4', 995, 11],
  ['error_code5', 1007, 11], ['error_code6', 1019, 11],
  ['error_code7', 1031, 11], ['error_code8', 1043, 11],
  ['remarks', 1055, 154], ['lob', 1210, 1], ['company_code', 1212, 1],
  ['unique_rout_id', 1214, 16], ['state_code', 1231, 2],
  ['anniv_date', 1234, 8], ['done_date', 1243, 8], ['done_user', 1252, 6],
  // MVR violation fields
  ['mvr_viol_date1', 1259, 8], ['mvr_viol_info1', 1268, 40],
  ['mvr_viol_date2', 1309, 8], ['mvr_viol_info2', 1318, 40],
  ['mvr_viol_date3', 1359, 8], ['mvr_viol_info3', 1368, 40],
  ['mvr_viol_date4', 1409, 8], ['mvr_viol_info4', 1418, 40],
  ['mvr_viol_date5', 1459, 8], ['mvr_viol_info5', 1468, 40],
  ['cancel_eff_date', 1513, 8], ['status_code', 1522, 2],
]
...
function transformRecord(raw: Record<string, string>, dateOfRun: string): RouteItem {
  ...
  const description = policyItem.toUpperCase() === 'GFU' ? gfuErrorText.slice(0, 50) : descriptionRaw
