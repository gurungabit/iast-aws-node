      ...
      <div className="space-y-4">
        ...
        {details && (
          <details className="text-xs text-gray-500 dark:text-zinc-500">
            <summary className="cursor-pointer hover:text-gray-700 dark:hover:text-zinc-300">Show details</summary>
            <pre className="mt-2 whitespace-pre-wrap bg-gray-100 dark:bg-zinc-800 p-2 rounded text-xs">{details}</pre>
          </details>
        )}
      </div>
