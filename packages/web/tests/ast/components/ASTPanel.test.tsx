...
vi.mock('@src/hooks/useFormField', () => ({
  useFormField: mockUseFormField,
}))

vi.mock('@src/ast/login/register', () => ({}))
vi.mock('@src/ast/bi-renew/register', () => ({}))
vi.mock('@src/ast/rout-extractor/register', () => ({}))

vi.mock('@src/ast/components/ASTSelector', () => ({
...
import { ASTPanel } from '@src/ast/components/ASTPanel'
